    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnionStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PgpPublicKey = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeText = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    Verified = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PGPVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PGPVerifications_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnionStatuses_OnionUrl",
                table: "OnionStatuses",
                column: "OnionUrl",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PGPVerifications_UserId",
                table: "PGPVerifications",
                column: "UserId");
