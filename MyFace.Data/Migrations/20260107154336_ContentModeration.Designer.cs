...
namespace MyFace.Data.Migrations
{
    ...
    [Migration("20260107154336_ContentModeration")]
    partial class ContentModeration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFace.Core.Entities.UserInfraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("ContentModified")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("MuteExpiresAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("TorFingerprint")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.Property<int?>("WordListEntryId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("MuteExpiresAt");

                    b.HasIndex("OccurredAt");

                    b.HasIndex("SessionFingerprint");

                    b.HasIndex("TorFingerprint");

                    b.HasIndex("UserId");

                    b.HasIndex("WordListEntryId");

                    b.HasIndex("UserId", "MuteExpiresAt");

                    b.ToTable("UserInfractions");
                });
            ...
            modelBuilder.Entity("MyFace.Core.Entities.WordListEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("MuteDurationHours")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyFace.Core.Entities.UserInfraction", b =>
                {
                    ...
                    b.HasOne("MyFace.Core.Entities.WordListEntry", "WordListEntry")
                        .WithMany()
                        .HasForeignKey("WordListEntryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("User");

                    b.Navigation("WordListEntry");
                });
            ...
            modelBuilder.Entity("MyFace.Core.Entities.WordListEntry", b =>
                {
                    b.HasOne("MyFace.Core.Entities.User", "CreatedBy")
                        .WithMany()
