...
builder.Services.AddScoped<PostLogService>();
...
builder.Services.AddScoped<CaptchaThresholdService>();
builder.Services.AddSingleton<MyFace.Web.Services.ChatPresenceService>();
builder.Services.AddScoped<CustomHtmlStudioService>();
...
builder.Services.AddScoped<MyFace.Services.ChatSnapshotService>();
builder.Services.AddScoped<ThreadImageStorageService>();
builder.Services.AddScoped<ControlPanelAuditService>();
builder.Services.AddScoped<ControlPanelDataService>();
...
builder.Services.Configure<CustomHtmlSettings>(builder.Configuration.GetSection("CustomHtmlSettings"));
builder.Services.Configure<CustomHtmlStorageOptions>(builder.Configuration.GetSection("CustomHtmlStorage"));
...
app.UseSession();
app.UseMiddleware<MyFace.Web.Middleware.SessionTimeoutMiddleware>();
